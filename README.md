...
Like DXVK, this library is being built as a Windows DLL using MinGW. DXVK-NVAPI needs MinGW 9 due to the need for recent D3D12 headers. Python 3 is needed for a prebuild validation script. This project uses git submodules, ensure to fetch them while or after cloning the repository.
...
DXVK-NVAPI is enabled by default in Lutris since 0.5.9-beta1 and newer. It's updated automatically.
