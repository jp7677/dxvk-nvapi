...
TEST_CASE("D3D12 methods succeed", "[.d3d12]") {
    ...
    SECTION("BuildRaytracingAccelerationStructureEx succeeds when ID3D12GraphicsCommandListExt1 interface can't be found") {
        ALLOW_CALL(commandList, QueryInterface(ID3D12GraphicsCommandListExt1::guid, _))
            .RETURN(E_NOINTERFACE);
    ...
    SECTION("BuildRaytracingAccelerationStructureEx fails when Opacity Micromaps are used but ID3D12GraphicsCommandListExt1 interface can't be found") {
        ALLOW_CALL(commandList, QueryInterface(ID3D12GraphicsCommandListExt1::guid, _))
            .RETURN(E_NOINTERFACE);
    ...
    SECTION("BuildRaytracingAccelerationStructureEx succeeds when ID3D12GraphicsCommandListExt1 interface can be found") {
