...
#define INSERT_AND_RETURN_WHEN_EQUALS(method) \
    ...
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D12_GetRaytracingMultiIndirectClusterOperationRequirementsInfo)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D12_RaytracingExecuteMultiIndirectClusterOperation)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D12_GetRaytracingPartitionedTlasIndirectPrebuildInfo)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D12_BuildRaytracingPartitionedTlasIndirect)
