...
#define INSERT_AND_RETURN_WHEN_EQUALS(method) \
    ...
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D11_CreateVertexShaderEx)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D11_CreateGeometryShaderEx_2)
    ...
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D_QueryMultiViewSupport)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D_SetMultiViewMode)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D_QuerySinglePassStereoSupport)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D_SetSinglePassStereoMode)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D_QueryModifiedWSupport)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_D3D_SetModifiedWMode)
    ...
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_DISP_GetDisplayConfig)
    INSERT_AND_RETURN_WHEN_EQUALS(NvAPI_DISP_SetDisplayConfig)
