...
namespace dxvk {
    inline std::string fromCode(const uint32_t code) {
        static const std::map<uint32_t, std::string> codes{
            ...
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_GET_CLUSTER_ID),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_GET_CANDIDATE_CLUSTER_ID),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_GET_COMMITTED_CLUSTER_ID),
            MAP_ENUM_VALUE(NV_EXTN_OP_HIT_OBJECT_GET_CLUSTER_ID),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_CANDIDATE_TRIANGLE_OBJECT_POSITIONS),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_COMMITTED_TRIANGLE_OBJECT_POSITIONS),
            MAP_ENUM_VALUE(NV_EXTN_OP_HIT_OBJECT_GET_TRIANGLE_OBJECT_POSITIONS),

            MAP_ENUM_VALUE(NV_EXTN_OP_RT_SPHERE_OBJECT_POSITION_AND_RADIUS),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_CANDIDATE_SPHERE_OBJECT_POSITION_AND_RADIUS),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_COMMITTED_SPHERE_OBJECT_POSITION_AND_RADIUS),
            MAP_ENUM_VALUE(NV_EXTN_OP_HIT_OBJECT_GET_SPHERE_OBJECT_POSITION_AND_RADIUS),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_LSS_OBJECT_POSITIONS_AND_RADII),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_CANDIDATE_LSS_OBJECT_POSITIONS_AND_RADII),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_COMMITTED_LSS_OBJECT_POSITIONS_AND_RADII),
            MAP_ENUM_VALUE(NV_EXTN_OP_HIT_OBJECT_GET_LSS_OBJECT_POSITIONS_AND_RADII),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_IS_SPHERE_HIT),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_CANDIDATE_IS_NONOPAQUE_SPHERE),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_COMMITTED_IS_SPHERE),
            MAP_ENUM_VALUE(NV_EXTN_OP_HIT_OBJECT_IS_SPHERE_HIT),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_IS_LSS_HIT),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_CANDIDATE_IS_NONOPAQUE_LSS),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_COMMITTED_IS_LSS),
            MAP_ENUM_VALUE(NV_EXTN_OP_HIT_OBJECT_IS_LSS_HIT),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_CANDIDATE_LSS_HIT_PARAMETER),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_COMMITTED_LSS_HIT_PARAMETER),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_CANDIDATE_BUILTIN_PRIMITIVE_RAY_T),
            MAP_ENUM_VALUE(NV_EXTN_OP_RT_COMMIT_NONOPAQUE_BUILTIN_PRIMITIVE_HIT),
        };
